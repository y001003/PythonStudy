...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\y0010\\Desktop\\pythonWorkspace\\pyGame\\enemy.png")
...
# 시작 시간정보
start_ticks = pygame.time.get_ticks() # 현재 시작시간 tick 을 받아옴
...
while running:
    ...
    # 경과 시간(ms)를 1000으로 나누어 초(s) 단위로 표시
